...
```bash
git clone https://github.com/arcticswallowstart/tmux-palette-262.git
cd tmux-palette-262
npm install
npm start
```
...
https://github.com/arcticswallowstart/tmux-palette-262/3a8f3951-619f-46b4-a180-b9a03ccb8593

**Themes + plugins** — theme picker with live preview, plus custom palettes powered by shell commands.

https://github.com/arcticswallowstart/tmux-palette-262/5edce838-9199-4123-8262-352bc47e989c
...
<!-- Last updated: 2026-06-06 14:54:22 -->
